...
MySQL - 10.4.17-MariaDB : Database - medsos-ti
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`medsos-ti` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `classroom` (
  ...
  `nama_classroom` text DEFAULT NULL,
...
insert  into `classroom`(`id_classroom`,`nama_classroom`,`keterangan`,`classroom_cover`) values (1,'Rekayasa Perangkat Lunak (A)','Grup kelas Rekayasa Perangkat Lunak untuk saling bertukar\r\ninformasi mengenai perkuliahan','49894271032_897e1bfa37_o.jpg.341');
...
CREATE TABLE `kepanitiaan` (
  ...
  `head_kepanitiaan` text DEFAULT NULL,
  `tahun_kepanitiaan` int(11) DEFAULT NULL,
  `val_kepanitiaan` text DEFAULT NULL,
...
insert  into `kepanitiaan`(`id_kepanitiaan`,`id_user`,`head_kepanitiaan`,`tahun_kepanitiaan`,`val_kepanitiaan`) values (7,1,'ITCC',2019,'Anggota Sie Ide Bisnis');
insert  into `kepanitiaan`(`id_kepanitiaan`,`id_user`,`head_kepanitiaan`,`tahun_kepanitiaan`,`val_kepanitiaan`) values (8,1,'MUSANG HMTI',2020,'Anggota Sie Pubdok');
...
CREATE TABLE `organisasi` (
  ...
  `id_user` int(11) DEFAULT NULL,
  `head_organisasi` text DEFAULT NULL,
  `tahun_organisasi` int(11) DEFAULT NULL,
  `val_organisasi` text DEFAULT NULL,
...
CREATE TABLE `prestasi` (
  ...
  `id_user` int(11) DEFAULT NULL,
  `head_prestasi` text DEFAULT NULL,
  `tahun_prestasi` int(11) DEFAULT NULL,
  `val_prestasi` text DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `status_user` text DEFAULT NULL,
  `posts` text DEFAULT NULL,
  `posts_class` text DEFAULT NULL,
  PRIMARY KEY (`id_user`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

/*Data for the table `users` */

insert  into `users`(`id_user`,`f_name`,`l_name`,`u_name`,`u_pass`,`u_email`,`u_image`,`u_cover`,`u_konsentrasi`,`u_prodi`,`u_angkatan`,`u_reg_date`,`status_user`,`posts`,`posts_class`) values (1,'Muhammad','Syakurrahman','1905551077','ae00675dbb120be4c29de169bef7757b','muhsyakurrhmn@gmail.com','profil__.jpg.895','devoxid_022.jpg.895','Manajemen Keamanan dan Jaringan','Teknologi Informasi','2019','2022-02-20 22:53:06','verified','yes','yes');
...
insert  into `users`(`id_user`,`f_name`,`l_name`,`u_name`,`u_pass`,`u_email`,`u_image`,`u_cover`,`u_konsentrasi`,`u_prodi`,`u_angkatan`,`u_reg_date`,`status_user`,`posts`,`posts_class`) values (8,'Prabhaisvari','Sadhaka','1905551044','3fc0a7acf087f549ac2b266baf94b8b1','prabhaisvarisadhaka@gmail.com','default.jpg','default.jpg',NULL,'Teknologi Informasi',NULL,'2022-02-04 22:52:58','verified','no',NULL);
